...
function draw() 
{
  ...
  if(frameCount%30 === 0 && time > 0 && con2 != null && con != null){
    time -= 1;
  }
      ...
      swal(
        {
          ...
          imageUrl:
            "https://png.pngitem.com/pimgs/s/152-1526969_timer-clock-stopwatch-clip-art-timer-clipart-hd.png",
          imageSize: "150x150",
          confirmButtonText: "Play Again"
        },
        function(isConfirm) {
  ...
  textSize(50);
  if(time > 9){
  text("0:" + time, width - 110,50);
  }else {
    text("0:0" + time, width - 110, 50);
  }
}
